/**
 * BlackMagic-js - ES Module Version
...
class BlackMagic {
  ...
  adjustColorsForTheme(theme) {
    ...
    elements.forEach(element => {
      ...
      // Skip elements that have semantic meaning and should keep their colors
      const hasSemanticColor = element.classList.contains('btn-primary') || 
      ...
      if (hasSemanticColor) {
        return; // Keep semantic colors unchanged
      }
